...
* The main test conversion now targets direct QuioteRouting usage without runtime XML parsing.

Regenerate (example):

    php generate_symfony_routes.php test/sandbox/app/Config/tests/routing_simple.xml#context=test1:test/GeneratedRoutes/test1,Quiote\\Test\\Generated\\Test1
