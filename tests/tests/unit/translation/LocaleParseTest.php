...
class LocaleParseTest extends TestCase
{
    ...
    public function testOptionOnlyIdentifierRequiresFallback(): void
    {
        ...
        QuioteLocale::parseLocaleIdentifier('@timezone=UTC');
    }
    ...
    {
        $paths = QuioteLocale::getLookupPath('en_US_POSIX');
    ...
    {
        $paths = QuioteLocale::getLookupPath('zh_Hans_CN');
    ...
    {
        $paths = QuioteLocale::getLookupPath('sl_Latn_SI_NEDIS');
    ...
    {
        $parsed = QuioteLocale::parseLocaleIdentifier('de_AT');
        $paths = QuioteLocale::getLookupPath($parsed);
        $this->assertSame(['de_AT','de'], $paths);
    }

    public function testMultipleFlagOptions(): void
    {
        $data = QuioteLocale::parseLocaleIdentifier('en@featureX,featureY');
        $this->assertArrayHasKey('featureX', $data['options']);
    ...
    {
        $data = QuioteLocale::parseLocaleIdentifier('fr_FR@timezone=Europe/Paris');
