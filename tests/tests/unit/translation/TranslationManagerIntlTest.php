...
/**
 * Tests for the new intl-based TranslationManager implementation.
 * These tests intentionally avoid legacy calendar/timezone classes that were removed.
 */
#[IsolationEnvironment('testing-use_translation_on')]
class TranslationManagerIntlTest extends UnitTestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        // tests such as NumberValidatorTest.
