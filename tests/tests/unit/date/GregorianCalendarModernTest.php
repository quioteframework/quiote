...
/**
 * Slim parity for essential behavior of GregorianCalendarTest using native DateTime.
 */
class GregorianCalendarModernTest extends TestCase
{
    public function testNativeDateTimeFields(): void
    {
    ...
    public function testCustomOffsetTimezone(): void
    {
