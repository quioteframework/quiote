...
PHP);
		...
		$this->assertStringContainsString("'class' => 'Quiote\\\\Database\\\\DatabaseManager'", $exported);
		$this->assertStringContainsString("'validation_manager' => ", $exported);
		$this->assertStringContainsString("'shutdownOrder'", $exported);
	}
