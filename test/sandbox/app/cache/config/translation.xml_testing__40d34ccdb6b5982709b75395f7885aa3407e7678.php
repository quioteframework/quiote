...
// Compiled from: /home/markus/Projects/agavi/test/sandbox/app/Config//translation.xml
// Generated by: Agavi\Config\AgaviTranslationConfigHandler
...
$this->translators['default']['msg'] = new Agavi\Translation\AgaviGettextTranslator();
$this->translators['default']['msg']->initialize($this->getContext(), array (
  'text_domains' => 
  array (
    'menu' => '/home/markus/Projects/agavi/test/sandbox/app/data/i18n',
    'layout' => '/home/markus/Projects/agavi/test/sandbox/app/data/i18n',
    'Login' => '/home/markus/Projects/agavi/test/sandbox/app/data/i18n',
    'SearchEngineSpam' => '/home/markus/Projects/agavi/test/sandbox/app/data/i18n',
    'ErrorActions' => '/home/markus/Projects/agavi/test/sandbox/app/data/i18n',
  ),
));
$this->translatorFilters['default']['msg'] = array (
);
$this->translators['default']['num'] = new Agavi\Translation\AgaviNumberFormatter();
$this->translators['default']['num']->initialize($this->getContext(), array (
));
$this->translatorFilters['default']['num'] = array (
);
$this->translators['default']['cur'] = new Agavi\Translation\AgaviCurrencyFormatter();
$this->translators['default']['cur']->initialize($this->getContext(), array (
));
$this->translatorFilters['default']['cur'] = array (
);
$this->translators['default']['date'] = new Agavi\Translation\AgaviDateFormatter();
...
$this->translators['default.errors']['msg'] = new Agavi\Translation\AgaviSimpleTranslator();
...
$this->translators['ticket1099']['num'] = new Agavi\Translation\AgaviNumberFormatter();
$this->translators['ticket1099']['num']->initialize($this->getContext(), array (
  'format' => '##,###.00',
));
$this->translatorFilters['ticket1099']['num'] = array (
);
$this->translators['ticket1099']['cur'] = new Agavi\Translation\AgaviCurrencyFormatter();
$this->translators['ticket1099']['cur']->initialize($this->getContext(), array (
  'format' => '##,###.00',
));
$this->translatorFilters['ticket1099']['cur'] = array (
);
$this->translators['ticket1099']['date'] = new Agavi\Translation\AgaviDateFormatter();
