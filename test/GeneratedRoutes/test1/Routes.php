...
namespace AgaviTestGeneratedTest1;
use Symfony\Component\Routing\RouteCollection;
use AgaviTestGeneratedTest1\Modules\Test1Routes;
use AgaviTestGeneratedTest1\Modules\Module3Routes;
use AgaviTestGeneratedTest1\Modules\Module4Routes;
