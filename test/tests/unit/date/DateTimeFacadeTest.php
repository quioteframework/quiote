...
{
    public function testParseAndFormatBasicPattern()
    {
    ...
    public function testParseUTCAndFormatDifferentTimezone()
    {
    ...
    public function testRoundTripFallbackPattern()
    {
    ...
    public function testUnsupportedTokenThrows()
    {
