...
class ViewFactoryTest extends AgaviUnitTestCase
{
    ...
    public function testCreateSimpleViewWithAttributesSnapshot()
    {
        ...
        $ctx = $executor->execute($descriptor, $rd, $execState);
    ...
    $this->assertSame('CacheSuccess', $ctx->viewName);
        ...
        $view = $factory->create($ctx->viewModuleName, $ctx->viewName, $descriptor->module, $descriptor->action, $descriptor->outputType, $rd, $ctx->actionAttributes);
