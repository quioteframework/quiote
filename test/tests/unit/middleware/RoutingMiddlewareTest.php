 ...
 *
 * 1. AgaviRouting's RequestContext was never synced with the incoming request's HTTP
...
class RoutingMiddlewareTest extends TestCase
{
    ...
    /** Builds an AgaviRouting instance with a single route constrained to the given methods (empty = unconstrained). */
    private function routingWithRoute(string $path, array $methods = []): AgaviRouting
    {
        return new class($path, $methods) extends AgaviRouting {
    ...
    {
        // Regression: AgaviRouting's RequestContext defaulted to 'GET' and was never updated,
