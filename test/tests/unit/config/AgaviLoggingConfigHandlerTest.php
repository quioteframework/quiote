...
class AgaviLoggingConfigHandlerTest extends ConfigHandlerTestBase
{
	...
	{
		// AgaviPhpUnitTestCase::setUp() bootstraps Agavi in the testing environment
		// (the deprecated AgaviTesting::bootstrap() did the same thing).
		parent::setUp();
