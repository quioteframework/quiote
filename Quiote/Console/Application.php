...
use Quiote\Console\Command\MakeActionCommand;
use Quiote\Console\Command\MakeJobCommand;
use Quiote\Console\Command\MakeMiddlewareCommand;
use Quiote\Console\Command\MakeModuleCommand;
use Quiote\Console\Command\MiddlewareListCommand;
use Quiote\Console\Command\NewCommand;
use Quiote\Console\Command\OpenapiGenerateCommand;
use Quiote\Console\Command\PluginsListCommand;
...
final class Application extends SymfonyApplication
{
	public function __construct()
	{
		...
		$this->addCommand(new PluginsListCommand());
		$this->addCommand(new MiddlewareListCommand());
