...
/**
 * Optional, transitional base for services. This is scaffolding, not a permanent
 * parent: it exists so a half-migrated service can still reach
 * `$this->getContext()->getModel('Other')` while its collaborators are
 * converted to constructor injection. It does not extend Model — the DTO-style
 * getModel() convention and the service convention are deliberately un-conflated.
