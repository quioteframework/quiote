...
/**
 * SoapControllerCallHandler has the __call overload for the PHP SOAP ext.
 * @since      1.0.0
 * @version    1.0.0
 */
class SoapControllerCallHandler
{
	/**
	 ...
	 * @param      SoapController The SOAP controller to call doDispatch on.
	 * @since      1.0.0
	 */
