...
/**
 * AttributeHolder provides a base class for managing attributes with
 * namespaces. It contains all the functionality ParameterHolder provides.
 * @since      1.0.0
 * @version    1.0.0
 */
abstract class AttributeHolder extends ParameterHolder
{
	 ...
	 */
	protected $defaultNamespace = 'org.quiote';
	 ...
	 * @return     array<int, string> An indexed array of attribute namespaces.
	 * @since      1.0.0
	 */
