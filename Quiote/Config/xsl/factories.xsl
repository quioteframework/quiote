...
<xsl:stylesheet
	...
	xmlns:factories_1_0="http://quiote.dev/quiote/config/parts/factories/1.0"
	xmlns:factories_1_1="http://quiote.dev/quiote/config/parts/factories/1.1"
>
	<!--xmlns:factories_1_1="http://quiote.org/quiote/1.1/config/factories"-->
	
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="factories_1_0" select="'http://quiote.dev/quiote/config/parts/factories/1.0'" />
	<xsl:variable name="factories_1_1" select="'http://quiote.dev/quiote/config/parts/factories/1.1'" />
