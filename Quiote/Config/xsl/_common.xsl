...
<xsl:stylesheet
	...
	xmlns:envelope_1_0="http://quiote.dev/quiote/config/global/envelope/1.0"
	xmlns:envelope_1_1="http://quiote.dev/quiote/config/global/envelope/1.1"
>
	
	<xsl:variable name="envelope_0_11" select="'http://quiote.org/quiote/1.0/config'" />
	<xsl:variable name="envelope_1_0" select="'http://quiote.dev/quiote/config/global/envelope/1.0'" />
	<xsl:variable name="envelope_1_1" select="'http://quiote.dev/quiote/config/global/envelope/1.1'" />
