...
<xsl:stylesheet
	...
	xmlns:databases_1_0="http://quiote.dev/quiote/config/parts/databases/1.0"
	xmlns:databases_1_1="http://quiote.dev/quiote/config/parts/databases/1.1"
>
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="databases_1_0" select="'http://quiote.dev/quiote/config/parts/databases/1.0'" />
	<xsl:variable name="databases_1_1" select="'http://quiote.dev/quiote/config/parts/databases/1.1'" />
