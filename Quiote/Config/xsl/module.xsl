...
<xsl:stylesheet
	...
	xmlns:module_1_0="http://quiote.dev/quiote/config/parts/module/1.0"
	xmlns:module_1_1="http://quiote.dev/quiote/config/parts/module/1.1"
>
	...
	<xsl:variable name="module_1_0" select="'http://quiote.dev/quiote/config/parts/module/1.0'" />
	<xsl:variable name="module_1_1" select="'http://quiote.dev/quiote/config/parts/module/1.1'" />
