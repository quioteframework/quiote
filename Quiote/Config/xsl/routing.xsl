...
<xsl:stylesheet
	...
	xmlns:routing_1_0="http://quiote.dev/quiote/config/parts/routing/1.0"
	xmlns:routing_1_1="http://quiote.dev/quiote/config/parts/routing/1.1"
>
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="routing_1_0" select="'http://quiote.dev/quiote/config/parts/routing/1.0'" />
	<xsl:variable name="routing_1_1" select="'http://quiote.dev/quiote/config/parts/routing/1.1'" />
