...
<xsl:stylesheet
	...
	xmlns:settings_1_0="http://quiote.dev/quiote/config/parts/settings/1.0"
	xmlns:settings_1_1="http://quiote.dev/quiote/config/parts/settings/1.1"
>
	...
	<xsl:variable name="settings_1_0" select="'http://quiote.dev/quiote/config/parts/settings/1.0'" />
	<xsl:variable name="settings_1_1" select="'http://quiote.dev/quiote/config/parts/settings/1.1'" />
