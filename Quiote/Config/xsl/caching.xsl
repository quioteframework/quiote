...
<xsl:stylesheet
	...
	xmlns:caching_1_0="http://quiote.dev/quiote/config/parts/caching/1.0"
	xmlns:caching_1_1="http://quiote.dev/quiote/config/parts/caching/1.1"
>
	<xsl:output method="xml" version="1.0" encoding="utf-8" indent="yes" />
	
	<xsl:include href="_common.xsl" />
	
	<xsl:variable name="caching_1_0" select="'http://quiote.dev/quiote/config/parts/caching/1.0'" />
	<xsl:variable name="caching_1_1" select="'http://quiote.dev/quiote/config/parts/caching/1.1'" />
