...
<xsl:stylesheet
	...
	xmlns:compile_1_0="http://quiote.dev/quiote/config/parts/compile/1.0"
	xmlns:compile_1_1="http://quiote.dev/quiote/config/parts/compile/1.1"
>
	...
	<xsl:variable name="compile_1_0" select="'http://quiote.dev/quiote/config/parts/compile/1.0'" />
	<xsl:variable name="compile_1_1" select="'http://quiote.dev/quiote/config/parts/compile/1.1'" />
