...
/**
 * BaseConfigHandler allows a developer to create a custom formatted configuration file pertaining to
 * any information they like.
 *
 * A handler returns a declaration -- data -- from execute(); turning that into the compiled cache
 * file is the cache's job (see {@see CompiledArtifact}), not the handler's.
 * @since      1.0.0
 * @version    1.0.0
 */
