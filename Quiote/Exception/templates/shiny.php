...
} elseif(isset($container) && ($rd = $container->getRequestData()) !== null && $rd instanceof IHeadersRequestDataHolder && $rd->hasHeader('User-Agent')) {
	$ua = $rd->getHeader('User-Agent');
} elseif(isset($context) && ($rq = $context->getRequest()) !== null && !$rq->isLocked() && ($rd = $rq->getRequestData()) !== null && $rd instanceof IHeadersRequestDataHolder) {
	$ua = $rd->getHeader('User-Agent');
}*/
...
?>
		<section>
			...
			<div class="container">
				<dl>
					<dt>Quiote:</dt>
					<dd><?php echo htmlspecialchars((string) Config::get('quiote.version')); ?></dd>
					<dt>PHP:</dt>
