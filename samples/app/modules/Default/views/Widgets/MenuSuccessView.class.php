<?php
class Default_Widgets_MenuSuccessView extends SampleAppDefaultBaseView
{
	...
	public function executeHtml(RequestDataHolder $rd)
	{
		...
		$items[sprintf("javascript: alert('%s'); location.href = '%s';", $this->tm->_('You will now be redirected to an invalid URL. If no rewrite rules are in place, this means you will see a standard 404 page of your web server, unless you configured an ErrorDocument 404 or some similar setting. If rewrite rules are in place (i.e. no index.php part in the URL), you will be shown the Quiote 404 document. This is correct and expected behavior.', 'default.menu'), $this->ro->gen('asdjashdasd'))] = $this->tm->_('Call invalid URL', 'default.menu');
