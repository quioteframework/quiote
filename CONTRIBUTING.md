...
1. Send a [pull request](https://help.github.com/pull-requests/) to Quiote.
...
into Quiote. You may add a [CHANGELOG](CHANGELOG) entry suggestion to the pull
request ticket.

## Coding styles

Please see the [coding style hints](https://github.com/quiote/quiote/wiki/CodingStyle) before making changes
and try to adhere to them as otherwise incorporating the changes into Quiote is
...
licenses. For a list of contributors see the [github contributors graph](https://github.com/quiote/quiote/graphs/contributors).
...
Commits are continously integrated via [TravisCI](https://travis-ci.org/quiote/quiote)
