 ...
 * @subpackage security
 */
final class PdoRateLimiterStorage implements StorageInterface
{
    public function __construct(
        private readonly \PDO $pdo,
        private readonly string $table = 'agavi_rate_limit'
    ) {
    }
     ...
     */
    public static function schema(string $table = 'agavi_rate_limit'): string
    {
        return sprintf(
