...
/**
 * Lightweight HTML form repopulation utility replacing AgaviFormPopulationFilter for container-less pipeline.
...
{
    public static function repopulate(string $html, array $parameters, ?AgaviValidationReport $report = null, array $config = []): string
    {
        if($html === '') { return $html; }
        $dom = new \DOMDocument();
        @$dom->loadHTML($html);
