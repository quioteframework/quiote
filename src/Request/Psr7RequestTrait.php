...
{
    /**
     * Helper used by AgaviWebRequest for reading intrinsic HTTP request data.
     ...
     * AgaviWebRequest (setParameter / appendParameter) to preserve the historic
     ...
     * only through the AgaviWebRequest API, not raw attributes.
     *
     * Resolution order here (lowest precedence first – higher layers override
     * in AgaviWebRequest::getParameter before delegating to this helper):
